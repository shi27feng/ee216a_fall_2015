...
analyze -format verilog {SynLib.v fp_to_smc_float.v smc_float_multiplier.v smc_float_adder.v smc_float_to_fp.v reg_16.v reg_32.v NLC_1ch.v}
...
set_voltage 0.95 -object_list {VDD_sub}
